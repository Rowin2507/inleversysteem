  ...
  echo '
    <div class="melding-bg">
      <div class="melding-block">
        ...
        <p>Recaptcha was niet aangevinkt!</p>
        <p><a style="color: #e62686;" href="../inloggen">Klik hier om het opnieuw te proberen.</a></p>
      </div>
    </div>';
  exit;
}
$secretKey = "6LdpVEMUAAAAAIr6FFoHENoW4XjuI9SjGSeNxTq9";
